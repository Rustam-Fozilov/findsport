<ul id="menu" class="page-sidebar-menu">
    ...
    <li {!! (Request::is('admin/types') || Request::is('admin/options') || Request::is('admin/sports') || Request::is('admin/coatings') || Request::is('admin/inventories')  ? 'class="active"' : '' ) !!}>
        <a href="#">
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('admin/types') ? 'class="active"' : '' ) !!}>
                <a href="{{ URL::to('admin/types') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Types
                 </a>
            </li>
            <li {!! (Request::is('admin/options') ? 'class="active"' : '' ) !!}>
                <a href="{{ URL::to('admin/options') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Infrastructure
                </a>
            </li>
            <li {!! (Request::is('admin/sports') ? 'class="active"' : '' ) !!}>
                <a href="{{ URL::to('admin/sports') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Sports
                </a>
            </li>
            <li {!! (Request::is('admin/coatings') ? 'class="active"' : '' ) !!}>
                <a href="{{ URL::to('admin/coatings') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Coatings
                </a>
            </li>
            <li {!! (Request::is('admin/inventories') ? 'class="active"' : '' ) !!}>
    ...
    <li {!! (Request::is('admin/playgrounds')? 'class="active"' : '' ) !!}>
        <a href="{{ URL::to('admin/playgrounds') }}">
    ...
    <li {!! (Request::is('admin/img-manager') ? 'class="active"' : '' ) !!}>
        <a href="{{ URL::to('admin/img-manager') }}">
