...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li> @lang('table/title.blog')</li>
        <li class="active">@lang('table/title.blogdetail')</li>
    </ol>
</section>
<!--section ends-->
    ...
    <div class="row">
        <div class="col-sm-11 col-md-12 col-full-width-right">
            ...
            <div class="the-box no-border blog-detail-content">
                ...
                <hr>
                <p>
                    <span class="label label-success square">@lang('table/title.comments')</span>
                </p>
                @if(!empty($comments))
                ...
                <hr>
                <p>
                    <span class="label label-info square">@lang('table/title.leavecomment')</span>
                </p>
                ...
                <div class="form-group {{ $errors->has('comment') ? 'has-error' : '' }}">
                    {!! Form::textarea('comment', null, ['class' => 'form-control input-lg no-resize','required' =>
                    'required','id'=>'comment', 'style'=>'height: 200px', 'placeholder'=>trans('blog/form.ph-comment')])
                    !!}
