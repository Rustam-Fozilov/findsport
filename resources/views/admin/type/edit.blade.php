...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href="#">@lang('table/title.blog')</a>
        </li>
        <li class="active">@lang('table/title.edit')</li>
    </ol>
</section>
<!--section ends-->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{ $errors->first('blog_category_id', 'has-error') }}">
                            ...
                            {!! Form::select('blog_category_id',$blogcategory ,null, ['class' => 'form-control select2','id'=>'blog_category', 'placeholder'=>trans('blog/form.select-category')])!!}
                            <span class="help-block">{{ $errors->first('blog_category_id', ':message') }}</span>
                        </div>
                        <div class="form-group">
                            {!! Form::text('tags', $blog->tagList, ['class' => 'form-control input-lg', 'data-role'=>"tagsinput", 'placeholder'=>trans('blog/form.tags')])!!}
                        </div>
                        <label>@lang('table/form.lb-featured-img')</label>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-success blog_submit">@lang('table/form.update')</button>
                            <a href="{{ URL::to('admin/blog') }}" class="btn btn-danger">@lang('table/form.cancel')</a>
                        </div>
                    </div>
                    <!-- /.col-sm-4 --> </div>
        </div>
