...
(function( $, undef )
{
	...
	$.fn.dotdotdot.defaults = {
		...
		'callback'			: null,      // Callback function that is fired after the ellipsis is added, receives two parameters: isTruncated(boolean), orgContent(string).
		'after'				: null,      // jQuery-selector for the element to keep and put after the el
...
(function () {
	...
	dotdotdotCustom = function (selector, options)
	{
